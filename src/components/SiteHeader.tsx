...
import savLogo from "@/assets/sav-logo-mark.png";
...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur-md bg-background/85 border-b border-border">
      <div className="max-w-7xl mx-auto px-6 h-28 py-2 flex items-center justify-between gap-4">
        <Link to="/" className="flex items-center gap-3 group shrink-0">
          <img src={savLogo} alt="Sav Group" className="h-20 md:h-24 w-auto object-contain" />
        </Link>
